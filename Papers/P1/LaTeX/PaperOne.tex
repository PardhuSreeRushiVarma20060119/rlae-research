...
\quad \text{(for a fixed diagnostic threshold $\tau$.)}
\]
Here, $\mathrm{ILS}_{\mathrm{flag}}(p_i)$ is a binary indicator (“flag”) that marks whether prompt $p_i$ exhibits residual identity leakage beyond a fixed diagnostic threshold $\tau$.
