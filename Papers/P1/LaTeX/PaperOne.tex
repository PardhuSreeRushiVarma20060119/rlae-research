...
The goal of our experimental evaluation is not to maximize task performance, but to empirically assess \emph{recoverability}, \emph{identity preservation}, and \emph{structural robustness} under different adaptation paradigms. Accordingly, our experiments are designed to isolate the structural effects of adaptation and rollback, rather than to benchmark accuracy on downstream tasks.
